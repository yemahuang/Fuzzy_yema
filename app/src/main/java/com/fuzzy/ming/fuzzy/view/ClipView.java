...
public class ClipView extends View {
    ...
    private int customBottomHeight = 0;
    /** 裁剪框长宽比，默认4：3 */
    ...
    protected void onDraw(Canvas canvas) {
		...
		*/
        ...
        // bottom
        canvas.drawRect(0, clipTopMargin + clipHeight, width, height-customBottomHeight, paint);
    ...
    public int getCustomBottomHeight() {
        return customBottomHeight;
    }

    public void setCustomBottomHeight(int customBottomHeight) {
